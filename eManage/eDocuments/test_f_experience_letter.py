...
def test_experience_letter():
    with sync_playwright() as p:
        ...
        celebration_photo_upload.nth(5).click()
        ...
        page.locator("li:has-text('Admin')").click()
        time.sleep(3)
        page.locator("#view-doc-7-experience_letter").nth(0).click()
        ...
        #delete the document
        page.locator("#view-doc-7-experience_letter").click()
        page.locator("#view-doc-edit").click()
