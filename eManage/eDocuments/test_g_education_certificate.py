...
def test_education_certificate():
    with sync_playwright() as p:
        ...
        celebration_photo_upload.nth(6).click()
        ...
        page.locator("li:has-text('Admin')").click()
        time.sleep(3)
        page.locator("#view-doc-7-education_certificate").nth(0).click()
        ...
        #delete the document
        page.locator("#view-doc-7-education_certificate").click()
        page.locator("#view-doc-edit").click()
