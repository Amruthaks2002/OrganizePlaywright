...
def test_ai_suggestions_feedback():
    with sync_playwright() as p:
        ...
        create_btn.click()
        time.sleep(1)
        page.get_by_placeholder("Describe your feedback or idea...").fill("Great work on the dashboard design. The layout is clear and easy to understand.")
        time.sleep(1)
